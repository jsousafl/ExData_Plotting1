...
#Creating plot
par(mfcol = c(2,2))
plot(test_df$DateANDTime, test_df$Global_active_power, type = "l", 
...
plot(test_df$DateANDTime, test_df$Voltage, type = "l", 
     xlab = "datetime", ylab = "Voltage")
plot(test_df$DateANDTime, test_df$Global_reactive_power, type = "l", 
